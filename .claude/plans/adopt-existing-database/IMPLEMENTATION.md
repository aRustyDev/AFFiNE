...
**Design:** [`PLAN.md`](PLAN.md) · Decisions: [`findings/decision-log.md`](findings/decision-log.md)
...
In `scripts/woven-patch-manifest.md`, replace step 2 of the "Merge-time checklist" section. It
currently says to audit incoming migrations by hand and admits it is "a prompt to a human, not the
guard item 1 asks for". Replace with:
...
Design: `.claude/plans/adopt-existing-database/PLAN.md`.
